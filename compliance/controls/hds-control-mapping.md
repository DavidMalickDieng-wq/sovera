...
certified HDS for activities 1–2 and 5; Gardia operates activities 3, 4, 6 on top).

| HDS § | Requirement (summary) | Gardia implementation | Evidence file |
|---|---|---|---|
...
| 5.2.1 | Strong authentication for admins | Entra ID with conditional access (customer subscription). Postgres Entra-group admin (`gardia-admins`). KV Administrator only granted to the admin group. | `evidence/rbac-export.json` |
...
- Application code deployed *on top of* Gardia (custom Functions, custom DAB
